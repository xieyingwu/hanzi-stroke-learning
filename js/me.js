...
const learned = parseInt(localStorage.getItem('userLearned') || '0');
const days = calcLearningDays(user.joinDate);
document.getElementById('meStars').textContent = stars;
document.getElementById('meLearned').textContent = learned;
document.getElementById('meDays').textContent = days;
  } else {
...
function calcLearningDays(joinDate) {
